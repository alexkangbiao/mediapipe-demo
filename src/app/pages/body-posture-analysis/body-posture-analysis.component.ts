...
import { MediaPipeComponents } from 'src/app/media-pipe-demo/media-pipe-component';
...
@Component({
  selector: 'app-body-posture-analysis',
  templateUrl: '../../media-pipe-demo/media-pipe-demo.component.html',
  styleUrls: ['../../media-pipe-demo/media-pipe-demo.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BodyPostureAnalysisComponent extends MediaPipeComponents {
  pose!: mpPose.Pose;
